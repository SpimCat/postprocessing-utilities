...
import de.mpicbg.rhaase.spimcat.postprocessing.fijiplugins.deprecated.StandardDeviationPerPixelPlugin;
...
@Plugin(type = Command.class, menuPath = "SpimCat>EDF projection>Max Standard Deviation projection")
